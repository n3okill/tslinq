...
export const aggregate = async <TSource, TAccumulate, TResult>(
  iterator: AsyncIterator<TSource>,
  seed: TAccumulate | Types.AggregateFunctionTypeAsync<TSource, TAccumulate>,
