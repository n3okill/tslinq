...
export const minBy = async <T, TKey>(iterator: AsyncIterator<T>, keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> | Interfaces.IAsyncCompareTo<TKey>): Promise<T> => {
