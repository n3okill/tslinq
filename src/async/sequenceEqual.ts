...
export const sequenceEqual = async <T>(iterator: AsyncIterator<T>, second: AsyncIterable<T>, comparer: Interfaces.IEqualityComparer<T> | Interfaces.IAsyncEqualityComparer<T>): Promise<boolean> => {
