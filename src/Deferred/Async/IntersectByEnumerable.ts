...
export class IntersectByEnumerable<T, TKey> extends EnumerableAsync<T> {
    ...
    constructor(souce: EnumerableAsync<T>, second: AsyncIterable<TKey> | Iterable<TKey>, private readonly _keySelector: Types.TKeySelectorAsync<T, TKey>, private readonly _comparer: Types.TIAsyncEqualityComparer<TKey>) {
        super(souce);
