...
export class GroupJoinEnumerable<TInner, TKey, TResult, T> extends EnumerableAsync<TResult> {
    ...
    constructor(source: EnumerableAsync<T>, inner: AsyncIterable<TInner> | Iterable<TInner>, private readonly _outerKeySelector: Types.TKeySelectorAsync<T, TKey>, private readonly _innerKeySelector: Types.TKeySelectorAsync<TInner, TKey>, private readonly _resultSelector: Types.TResultSelectorAsync<TKey, TInner, TResult>, private readonly _comparer: Types.TIAsyncEqualityComparer<TKey>) {
