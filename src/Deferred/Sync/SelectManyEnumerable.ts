...
export class SelectManyEnumerable<T, TResult, TCollection> extends Enumerable<TResult> {
  constructor(
    source: Enumerable<T>,
    private readonly _selector: Types.SelectManySelector<T, TCollection>,
    private readonly _resultSelector: Types.SelectManyResultSelector<T, TCollection, TResult>,
  ) {
