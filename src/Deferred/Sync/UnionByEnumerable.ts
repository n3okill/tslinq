...
export class UnionByEnumerable<T, TKey> extends Enumerable<T> {
    constructor(first: Enumerable<T>, private readonly _second: Iterable<TKey>, private readonly _keySelector: Types.TKeySelector<T, TKey>, private readonly _comparer: Interfaces.IEqualityComparer<TKey>) {
        super(first);
    }
