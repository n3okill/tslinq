...
export class OrderEnumerable<T, TKey> extends Enumerable<T> implements Interfaces.IOrderedEnumerable<T> {
    constructor(source: Enumerable<T>, private readonly _keySelector: Types.TKeySelector<T, TKey>, private readonly _comparer: Interfaces.ICompareTo<TKey>, private readonly _isDescending: boolean = false, private readonly _parent?: OrderEnumerable<T, TKey>) {
        super(source);
    }
    ...
    public thenBy<TKey>(keySelector: Types.TKeySelector<T, TKey>, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo<TKey>()): Interfaces.IOrderedEnumerable<T> {
        return new OrderEnumerable(this, keySelector, comparer, false, this as unknown as OrderEnumerable<T, TKey>);
    }

    public thenByDescending<TKey>(keySelector: Types.TKeySelector<T, TKey>, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo<TKey>()): Interfaces.IOrderedEnumerable<T> {
...
class EnumerableSorter<T, TKey> {
    ...
    constructor(private readonly _keySelector: Types.TKeySelector<T, TKey>, private readonly _comparer: Interfaces.ICompareTo<TKey>, private readonly _isDescending: boolean = false, private readonly _next?: EnumerableSorter<T, TKey>) {}
