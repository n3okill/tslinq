...
export class GroupByEnumerable<T, TKey, TResult, TElement> extends Enumerable<TResult> {
    constructor(source: Enumerable<T>, private _keySelector: Types.TKeySelector<T, TKey>, private _elementSelector: Types.TElementSelector<T, TElement>, private _resultSelector: Types.TResultSelector<TKey, TElement, TResult>, private _comparer: Interfaces.IEqualityComparer<TKey>) {
