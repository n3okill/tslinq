...
export class GroupJoinEnumerable<TInner, TKey, TResult, T> extends Enumerable<TResult> {
    constructor(source: Enumerable<T>, private readonly _inner: Iterable<TInner>, private readonly _outerKeySelector: Types.TKeySelector<T, TKey>, private readonly _innerKeySelector: Types.TKeySelector<TInner, TKey>, private readonly _resultSelector: Types.TResultSelector<TKey, TInner, TResult>, private readonly _comparer: Interfaces.IEqualityComparer<TKey>) {
