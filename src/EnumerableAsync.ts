...
export class EnumerableAsync<T> {
    ...
    static asEnumerableAsync = <TSource>(source: EnumerableAsync<TSource> | AsyncIterable<TSource> | Iterable<TSource>): EnumerableAsync<TSource> => {
        if (!Type.isAsyncIterable(source) && !Type.isIterable(source)) {
            throw new TypeError("source is not iterable.");
        }
        if (source instanceof EnumerableAsync) {
            return source;
        }
        if (Type.isIterable(source)) {
     ...
     */
    public async aggregate<TResult>(func: Types.AggregateFunctionTypeAsync<T, T>, resultSelector?: Types.AggregateResultTypeAsync<T, TResult>): Promise<TResult>;
    /**
     * Applies an accumulator function over a sequence.
     ...
     * @returns The final accumulator value.
     */
    public async aggregate<TAccumulate, TResult>(seed: TAccumulate, func: Types.AggregateFunctionTypeAsync<T, TAccumulate>, resultSelector?: Types.AggregateResultTypeAsync<TAccumulate, TResult>): Promise<TResult>;
    /**
     * Applies an accumulator function over a sequence.
     * The specified seed value is used as the initial accumulator value,
     ...
     */
    public async aggregate<TAccumulate, TResult>(seed: TAccumulate | Types.AggregateFunctionTypeAsync<T, TAccumulate>, func: Types.AggregateFunctionTypeAsync<T, TAccumulate> = (x) => x as unknown as TAccumulate, resultSelector: Types.AggregateResultTypeAsync<TAccumulate, TResult> = (o) => o as unknown as TResult): Promise<TResult> {
     ...
     */
    public async contains(value: T, comparer: Types.TIAsyncEqualityComparer<T> = new Interfaces.DefaultEqualityComparer()): Promise<boolean> {
     ...
     */
    public distinct(comparer: Types.TIAsyncEqualityComparer<T> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public distinctBy<TKey>(keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Types.TIAsyncEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public static empty<TSource>(type: Interfaces.IConstructor<Iterable<TSource> | AsyncIterable<TSource>>): Interfaces.IAsyncEnumerable<TSource> {
     ...
     */
    public except(second: Iterable<T>, comparer: Types.TIAsyncEqualityComparer<T> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public exceptBy<TKey>(second: Iterable<TKey>, keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Types.TIAsyncEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public async firstOrDefault(predicate: (x: T) => boolean | Promise<boolean> = () => true, defaultValue?: T): Promise<T> {
     ...
     */
    public groupBy<TKey, TResult>(keySelector: Types.TKeySelectorAsync<T, TKey>, resultSelector?: Types.TResultSelectorAsync<TKey, T, TResult> | Types.TIAsyncEqualityComparer<TKey>, comparer?: Types.TIAsyncEqualityComparer<TKey>): Interfaces.IAsyncEnumerable<TResult>;
    /**
     ...
     */
    public groupBy<TKey, TElement, TResult>(keySelector: Types.TKeySelectorAsync<T, TKey>, elementSelector: Types.TElementSelectorAsync<T, TElement>, resultSelector: Types.TResultSelectorAsync<TKey, TElement, TResult>, comparer?: Types.TIAsyncEqualityComparer<TKey>): Interfaces.IAsyncEnumerable<TResult>;
    public groupBy<TKey, TElement, TResult>(keySelector: Types.TKeySelectorAsync<T, TKey>, a?: Types.TElementSelectorAsync<T, TElement> | Types.TResultSelectorAsync<TKey, TElement, TResult> | Types.TIAsyncEqualityComparer<TKey>, b?: Types.TResultSelectorAsync<TKey, TElement, TResult> | Types.TIAsyncEqualityComparer<TKey>, c?: Types.TIAsyncEqualityComparer<TKey>): Interfaces.IAsyncEnumerable<TResult> {
    ...
    public groupByGrouped<TKey>(keySelector: Types.TKeySelectorAsync<T, TKey>): Interfaces.IAsyncEnumerable<Interfaces.IAsyncGrouping<TKey, T>>;
    public groupByGrouped<TKey, TElement>(keySelector: Types.TKeySelectorAsync<T, TKey>, elementSelector: Types.TElementSelectorAsync<T, TElement>): Interfaces.IAsyncEnumerable<Interfaces.IAsyncGrouping<TKey, T>>;
    public groupByGrouped<TKey, TElement>(keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, elementSelector: Types.TElementSelectorAsync<T, TElement> = (x) => x as unknown as TElement, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<Interfaces.IAsyncGrouping<TKey, TElement>> {
     ...
     */
    public groupJoin<TInner, TKey, TResult>(inner: AsyncIterable<TInner> | Iterable<TInner>, outerKeySelector: Types.TKeySelectorAsync<T, TKey>, innerKeySelector: Types.TKeySelectorAsync<TInner, TKey>, resultSelector: Types.TResultSelectorAsync<TKey, TInner, TResult>, comparer: Types.TIAsyncEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<TResult> {
        return new Deferred.Async.GroupJoinEnumerable(this, inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
    }
     ...
     */
    public intersect(second: AsyncIterable<T> | Iterable<T>, comparer: Interfaces.IEqualityComparer<T> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public intersectBy<TKey>(second: AsyncIterable<TKey> | Iterable<TKey>, keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Types.TIAsyncEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public join<TInner, TKey, TResult>(inner: AsyncIterable<TInner> | Iterable<TInner>, outerKeySelector: Types.TKeySelectorAsync<T, TKey>, innerKeySelector: Types.TKeySelectorAsync<TInner, TKey>, resultSelector: Types.TResultSelectorJoinAsync<T, TInner, TResult>, comparer: Types.TIAsyncEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<TResult> {
     ...
     */
    public async lastOrDefault(predicate: (x: T) => boolean | Promise<boolean> = () => true, defaultValue?: T): Promise<T> {
     ...
     */
    public async maxBy<TKey>(keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Types.TICompareTo<TKey> = new Interfaces.DefaultCompareTo()): Promise<T> {
     ...
     */
    public async minBy<TKey>(keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Types.TICompareTo<TKey> = new Interfaces.DefaultCompareTo()): Promise<T> {
     ...
     */
    public orderBy<TKey>(keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo()): Interfaces.IAsyncOrderedEnumerable<T> {
     ...
     */
    public orderByDescending<TKey>(keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo()): Interfaces.IAsyncOrderedEnumerable<T> {
    ...
    public static range(start: number | string, count: number): Interfaces.IAsyncEnumerable<number | string> {
        const result = [];
        const isString: boolean = Type.isString(start);
        let begin = isString ? (start as string).charCodeAt(0) : (start as number);
        while (count--) {
            result.push(begin++);
        }
        return new EnumerableAsync(Helpers.asAsyncIterable(isString ? String.fromCharCode(...result) : (result as never)));
    }
     ...
     */
    public select<TResult>(selector: (x: T, index?: number) => TResult | Promise<TResult> = (x) => x as unknown as TResult): Interfaces.IAsyncEnumerable<TResult> {
     ...
     */
    public selectMany<TCollection, TResult>(selector: Types.SelectManySelectorAsync<T, TCollection> = (x) => x as unknown as AsyncIterable<TCollection>, resultSelector: Types.SelectManyResultSelectorAsync<T, TCollection, TResult> = (x, y) => y as unknown as TResult): Interfaces.IAsyncEnumerable<TResult> {
     ...
     */
    public async sequenceEqual(second: AsyncIterable<T> | Iterable<T>, comparer: Interfaces.IEqualityComparer<T> | Interfaces.IAsyncEqualityComparer<T> = new Interfaces.DefaultEqualityComparer<T>()): Promise<boolean> {
     ...
     */
    public async singleOrDefault(predicate: (x: T) => boolean | Promise<boolean> = () => true, defaultValue?: T): Promise<T> {
     ...
     */
    public skipWhile(predicate: (element: T, index: number) => boolean | Promise<boolean> = () => true): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public async sum(selector: (element: T) => string | number | Promise<string | number> = (element) => element as unknown as number | string): Promise<string | number> {
     ...
     */
    public takeWhile(predicate: (element: T, index: number) => boolean | Promise<boolean> = () => true): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public union(second: AsyncIterable<T> | Iterable<T>, comparer: Interfaces.IEqualityComparer<T> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public unionBy<TKey>(second: AsyncIterable<TKey> | Iterable<TKey>, keySelector: Types.TKeySelectorAsync<T, TKey> = (x) => x as unknown as TKey, comparer: Types.TIAsyncEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public where(predicate: (x: T, index: number) => boolean | Promise<boolean> = () => true): Interfaces.IAsyncEnumerable<T> {
     ...
     */
    public zip<TSecond, TResult>(second: AsyncIterable<TSecond> | Iterable<TSecond>, resultSelector: Types.ZipResultSelectorAsync<T, TSecond, undefined, TResult>): Interfaces.IAsyncEnumerable<TResult>;
    public zip<TSecond, TThird, TResult>(second: AsyncIterable<TSecond> | Iterable<TSecond>, third: AsyncIterable<TThird> | Iterable<TThird>, resultSelector: Types.ZipResultSelectorAsync<T, TSecond, TThird, TResult>): Interfaces.IAsyncEnumerable<TResult>;
    public zip<TSecond, TThird, TResult>(second: AsyncIterable<TSecond> | Iterable<TSecond>, b?: AsyncIterable<TThird> | Iterable<TThird> | Types.ZipResultSelectorAsync<T, TSecond, TThird, TResult>, c?: Types.ZipResultSelectorAsync<T, TSecond, TThird, TResult>): Interfaces.IAsyncEnumerable<TResult> {
        ...
        } else if (Type.isFunction(b) || Type.isAsyncFunction(b)) {
        ...
        return new Deferred.Async.ZipEnumerable<T, TSecond, TThird, TResult>(this, Helpers.asAsyncIterable(second), third, resultSelector);
    }
}
