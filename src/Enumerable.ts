...
export class Enumerable<TSource> {
     ...
     */
    public aggregate<TResult>(func: Types.AggregateFunctionType<TSource, TSource>, resultSelector?: Types.AggregateResultType<TSource, TResult>): TResult;
    /**
     * Applies an accumulator function over a sequence.
     ...
     * @returns The final accumulator value.
     */
    public aggregate<TAccumulate, TResult>(seed: TAccumulate, func: Types.AggregateFunctionType<TSource, TAccumulate>, resultSelector?: Types.AggregateResultType<TAccumulate, TResult>): TResult;
    /**
     * Applies an accumulator function over a sequence.
     * The specified seed value is used as the initial accumulator value,
     ...
     */
    public aggregate<TAccumulate, TResult>(seed: TAccumulate | Types.AggregateFunctionType<TSource, TAccumulate>, func: Types.AggregateFunctionType<TSource, TAccumulate> = (x) => x as unknown as TAccumulate, resultSelector: Types.AggregateResultType<TAccumulate, TResult> = (o) => o as unknown as TResult): TResult {
     ...
     */
    public contains(value: TSource, comparer: Interfaces.IEqualityComparer<TSource> = new Interfaces.DefaultEqualityComparer()): boolean {
     ...
     */
    public distinct(comparer: Interfaces.IEqualityComparer<TSource> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public distinctBy<TKey>(keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public except(second: Iterable<TSource>, comparer: Interfaces.IEqualityComparer<TSource> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public exceptBy<TKey>(second: Iterable<TKey>, keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public groupBy<TKey, TResult>(keySelector: Types.TKeySelector<TSource, TKey>, resultSelector?: Types.TResultSelector<TKey, TSource, TResult> | Interfaces.IEqualityComparer<TSource>, comparer?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TResult>;
    /**
     ...
     */
    public groupBy<TKey, TElement, TResult>(keySelector: Types.TKeySelector<TSource, TKey>, elementSelector: Types.TElementSelector<TSource, TElement>, resultSelector: Types.TResultSelector<TKey, TElement, TResult>, comparer?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TResult>;
    public groupBy<TKey, TElement, TResult>(keySelector: Types.TKeySelector<TSource, TKey>, a?: Types.TElementSelector<TSource, TElement> | Types.TResultSelector<TKey, TElement, TResult> | Interfaces.IEqualityComparer<TKey>, b?: Types.TResultSelector<TKey, TElement, TResult> | Interfaces.IEqualityComparer<TKey>, c?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TResult> {
    ...
    public groupByGrouped<TKey>(keySelector: Types.TKeySelector<TSource, TKey>): Interfaces.IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
    public groupByGrouped<TKey, TElement>(keySelector: Types.TKeySelector<TSource, TKey>, elementSelector: Types.TElementSelector<TSource, TElement>): Interfaces.IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
    public groupByGrouped<TKey, TElement>(keySelector: Types.TKeySelector<TSource, TKey>, elementSelector: Types.TElementSelector<TSource, TElement> = (x) => x as unknown as TElement, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<Interfaces.IGrouping<TKey, TElement>> {
     ...
     */
    public groupJoin<TInner, TKey, TResult>(inner: Iterable<TInner>, outerKeySelector: Types.TKeySelector<TSource, TKey>, innerKeySelector: Types.TKeySelector<TInner, TKey>, resultSelector: Types.TResultSelector<TKey, TInner, TResult>, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TResult> {
        return new Deferred.Sync.GroupJoinEnumerable(this, inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
    }
     ...
     */
    public intersect(second: Iterable<TSource>, comparer: Interfaces.IEqualityComparer<TSource> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public intersectBy<TKey>(second: Iterable<TKey>, keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public join<TInner, TKey, TResult>(inner: Iterable<TInner>, outerKeySelector: Types.TKeySelector<TSource, TKey>, innerKeySelector: Types.TKeySelector<TInner, TKey>, resultSelector: Types.TResultSelectorJoin<TSource, TInner, TResult>, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TResult> {
     ...
     */
    public maxBy<TKey>(keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo()): TSource {
     ...
     */
    public minBy<TKey>(keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo()): TSource {
     ...
     */
    public orderBy<TKey>(keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo()): Interfaces.IOrderedEnumerable<TSource> {
     ...
     */
    public orderByDescending<TKey>(keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.ICompareTo<TKey> = new Interfaces.DefaultCompareTo()): Interfaces.IOrderedEnumerable<TSource> {
    ...
    public static range(start: number | string, count: number): Interfaces.IEnumerable<number | string> {
        ...
        return new Enumerable(isString ? String.fromCharCode(...result) : (result as never));
    }
     ...
     */
    public select<TResult>(selector: (x: TSource, index?: number) => TResult = (x) => x as unknown as TResult): Interfaces.IEnumerable<TResult> {
     ...
     */
    public selectMany<TCollection, TResult>(selector: Types.SelectManySelector<TSource, TCollection> = (x) => x as unknown as Iterable<TCollection>, resultSelector: Types.SelectManyResultSelector<TSource, TCollection, TResult> = (x, y) => y as unknown as TResult): Interfaces.IEnumerable<TResult> {
     ...
     */
    public sequenceEqual(second: Iterable<TSource>, comparer: Interfaces.IEqualityComparer<TSource> = new Interfaces.DefaultEqualityComparer<TSource>()): boolean {
     ...
     */
    public skipWhile(predicate: (element: TSource, index: number) => boolean = () => true): Interfaces.IEnumerable<TSource> {
     ...
     */
    public sum(selector: (element: TSource) => string | number = (element) => element as unknown as number | string): string | number {
     ...
     */
    public takeWhile(predicate: (element: TSource, index: number) => boolean = () => true): Interfaces.IEnumerable<TSource> {
     ...
     */
    public union(second: Iterable<TSource>, comparer: Interfaces.IEqualityComparer<TSource> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public unionBy<TKey>(second: Iterable<TKey>, keySelector: Types.TKeySelector<TSource, TKey> = (x) => x as unknown as TKey, comparer: Interfaces.IEqualityComparer<TKey> = new Interfaces.DefaultEqualityComparer()): Interfaces.IEnumerable<TSource> {
     ...
     */
    public zip<TSecond, TResult>(second: Iterable<TSecond>, resultSelector: (x: TSource, y: TSecond) => TResult): Interfaces.IEnumerable<TResult>;
    public zip<TSecond, TThird, TResult>(second: Iterable<TSecond>, third: Iterable<TThird>, resultSelector: (x: TSource, y: TSecond, z: TThird) => TResult): Interfaces.IEnumerable<TResult>;
    public zip<TSecond, TThird, TResult>(second: Iterable<TSecond>, b?: Iterable<TThird> | ((x: TSource, y: TSecond) => TResult), c?: (x: TSource, y: TSecond, z: TThird) => TResult): Interfaces.IEnumerable<TResult> {
