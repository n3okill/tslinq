...
export interface IAsyncEnumerable<TSource> extends AsyncIterable<TSource> {
   ...
   */
  aggregate<TResult>(
    func: Types.AggregateFunctionTypeAsync<TSource, TSource>,
    resultSelector?: Types.AggregateResultTypeAsync<TSource, TResult>,
  ): Promise<TResult>;
  /**
   * Applies an accumulator function over a sequence.
  ...
  aggregate<TAccumulate, TResult>(
    seed: TAccumulate,
    func: Types.AggregateFunctionTypeAsync<TSource, TAccumulate>,
   ...
   */
  distinctBy<TKey>(
    keySelector?: Types.TKeySelectorAsync<TSource, TKey>,
  ...
  groupBy<TKey, TResult>(
    keySelector: Types.TKeySelectorAsync<TSource, TKey>,
    resultSelector?: Types.TResultSelectorAsync<TKey, TSource, TResult> | Interfaces.IEqualityComparer<TKey>,
  ...
  groupBy<TKey, TElement, TResult>(
    keySelector: Types.TKeySelectorAsync<TSource, TKey>,
    elementSelector: Types.TElementSelectorAsync<TSource, TElement>,
  ...
  groupByGrouped<TKey>(
    keySelector: Types.TKeySelectorAsync<TSource, TKey>,
  ): Interfaces.IAsyncEnumerable<Interfaces.IAsyncGrouping<TKey, TSource>>;
  ...
  groupJoin<TInner, TKey, TResult>(
    ...
    outerKeySelector: Types.TKeySelectorAsync<TSource, TKey>,
   ...
   */
  intersect(
    second: AsyncIterable<TSource> | Iterable<TSource>,
  ...
  maxBy<TKey>(
    keySelector?: Types.TKeySelectorAsync<TSource, TKey>,
    comparer?: Types.TICompareTo<TKey>,
  ): Promise<TSource>;
  ...
  ): Interfaces.IAsyncOrderedEnumerable<TSource>;
   ...
   */
  sequenceEqual(
    second: Iterable<TSource> | AsyncIterable<TSource>,
    comparer?: Interfaces.IEqualityComparer<TSource>,
  ): Promise<boolean>;
  ...
  zip<TSecond, TResult>(
    ...
    resultSelector: Types.ZipResultSelectorAsync<TSource, TSecond, undefined, TResult>,
  ): IAsyncEnumerable<TResult>;
