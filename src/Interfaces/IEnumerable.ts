...
export interface IEnumerable<TSource> extends Iterable<TSource> {
     ...
     */
    aggregate<TResult>(func: Types.AggregateFunctionType<TSource, TSource>, resultSelector?: Types.AggregateResultType<TSource, TResult>): TResult;
    /**
     * Applies an accumulator function over a sequence.
     ...
     * @returns The final accumulator value.
     */
    aggregate<TAccumulate, TResult>(seed: TAccumulate, func: Types.AggregateFunctionType<TSource, TAccumulate>, resultSelector?: Types.AggregateResultType<TAccumulate, TResult>): TResult;
    /**
     * Applies an accumulator function over a sequence.
     * The specified seed value is used as the initial accumulator value,
     ...
     */
    chunk(size: number): Interfaces.IEnumerable<Array<TSource>>;
     ...
     */
    contains(value: TSource, comparer?: Interfaces.IEqualityComparer<TSource>): boolean;
     ...
     */
    defaultIfEmpty(defaultValue?: TSource): Interfaces.IEnumerable<TSource>;
     ...
     */
    distinct(comparer?: Interfaces.IEqualityComparer<TSource>): IEnumerable<TSource>;
     ...
     */
    distinctBy<TKey>(keySelector?: Types.TKeySelector<TSource, TKey>, comparer?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TSource>;
     ...
     */
    except(second: Iterable<TSource>, comparer?: Interfaces.IEqualityComparer<TSource>): IEnumerable<TSource>;

    /**
     * Produces the set difference of two sequences according to a specified key selector function.
     * [`ExceptBy`](https://docs.microsoft.com/en-us/dotnet/api/system.linq.enumerable.exceptby)
     */
    exceptBy<TKey>(second: Iterable<TKey>, keySelector?: Types.TKeySelector<TSource, TKey>, comparer?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TSource>;
     ...
     */
    forEach<TResult>(action: (x: TSource) => TResult): IEnumerable<TResult>;
     ...
     */
    groupBy<TKey, TResult>(keySelector: Types.TKeySelector<TSource, TKey>, resultSelector?: Types.TResultSelector<TKey, TSource, TResult> | Interfaces.IEqualityComparer<TKey>, comparer?: Interfaces.IEqualityComparer<TSource>): IEnumerable<TResult>;
    /**
     ...
     */
    groupBy<TKey, TElement, TResult>(keySelector: Types.TKeySelector<TSource, TKey>, elementSelector: Types.TElementSelector<TSource, TElement>, resultSelector?: Types.TResultSelector<TKey, TElement, TResult>, comparer?: Interfaces.IEqualityComparer<TSource>): IEnumerable<TResult>;

    groupByGrouped<TKey>(keySelector: Types.TKeySelector<TSource, TKey>): IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
    groupByGrouped<TKey, TElement>(keySelector: Types.TKeySelector<TSource, TKey>, elementSelector: Types.TElementSelector<TSource, TElement>): IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
    groupByGrouped<TKey, TElement>(keySelector: Types.TKeySelector<TSource, TKey>, elementSelector: Types.TElementSelector<TSource, TElement>, comparer?: Interfaces.IEqualityComparer<TKey>): IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
     ...
     */
    groupJoin<TInner, TKey, TResult>(inner: Iterable<TInner>, outerKeySelector: Types.TKeySelector<TSource, TKey>, innerKeySelector: Types.TKeySelector<TInner, TKey>, resultSelector: Types.TResultSelector<TKey, TInner, TResult>, comparer?: Interfaces.IEqualityComparer<TKey>): IEnumerable<TResult>;
     ...
     */
    intersect(second: Iterable<TSource>, comparer?: Interfaces.IEqualityComparer<TSource>): IEnumerable<TSource>;

    /**
     * Produces the set intersection of two sequences according to a specified key selector function.
     * [`IntersectBy`](https://docs.microsoft.com/en-us/dotnet/api/system.linq.enumerable.intersectby)
     */
    intersectBy<TKey>(second: Iterable<TKey>, keySelector?: Types.TKeySelector<TSource, TKey>, comparer?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TSource>;
     ...
     */
    join<TInner, TKey, TResult>(inner: Iterable<TInner>, outerKeySelector: Types.TKeySelector<TSource, TKey>, innerKeySelector: Types.TKeySelector<TInner, TKey>, resultSelector: Types.TResultSelectorJoin<TSource, TInner, TResult>, comparer?: Interfaces.IEqualityComparer<TKey>): IEnumerable<TResult>;
     ...
     */
    max(comparer?: Interfaces.ICompareTo<number>): number;
     ...
     */
    maxBy<TKey>(keySelector?: Types.TKeySelector<TSource, TKey>, comparer?: Interfaces.ICompareTo<TKey>): TSource;
     ...
     */
    min(comparer?: Interfaces.ICompareTo<number>): number;
     ...
     */
    minBy<TKey>(keySelector?: Types.TKeySelector<TSource, TKey>, comparer?: Interfaces.ICompareTo<TKey>): TSource;
     ...
     */
    ofType<TType extends Interfaces.OfType>(type: TType): IEnumerable<TType>;
     ...
     */
    orderBy<TKey>(keySelector?: (x: TSource) => TKey, comparer?: Interfaces.ICompareTo<TKey>): Interfaces.IOrderedEnumerable<TSource>;
     ...
     */
    orderByDescending<TKey>(keySelector?: (x: TSource) => TKey, comparer?: Interfaces.ICompareTo<TKey>): Interfaces.IOrderedEnumerable<TSource>;
     ...
     */
    selectMany<TCollection, TResult>(selector?: Types.SelectManySelector<TSource, TCollection>, resultSelector?: Types.SelectManyResultSelector<TSource, TCollection, TResult>): IEnumerable<TResult>;
     ...
     */
    sequenceEqual(second: Iterable<TSource>, comparer?: Interfaces.IEqualityComparer<TSource>): boolean;
     ...
     */
    skipLast(count: number): Interfaces.IEnumerable<TSource>;
     ...
     */
    sum(selector?: (x: TSource) => string | number): string | number;
     ...
     */
    takeWhile(predicate: (element: TSource, index: number) => boolean): IEnumerable<TSource>;
     ...
     */
    toMap<TKey>(selector: (x: TSource) => TKey): Map<TKey, Array<TSource>>;
     ...
     */
    union(second: Iterable<TSource>, comparer?: Interfaces.IEqualityComparer<TSource>): IEnumerable<TSource>;

    /**
     * Produces the set union of two sequences according to a specified key selector function.
     * [`UnionBy`](https://docs.microsoft.com/en-us/dotnet/api/system.linq.enumerable.unionby)
     */
    unionBy<TKey>(second: Iterable<TKey>, keySelector?: Types.TKeySelector<TSource, TKey>, comparer?: Interfaces.IEqualityComparer<TKey>): Interfaces.IEnumerable<TSource>;
    ...
    zip<TSecond, TThird, TResult>(second: Iterable<TSecond>, third: Iterable<TThird>, resultSelector: (x: TSource, y: TSecond, z: TThird) => TResult): IEnumerable<TResult>;
