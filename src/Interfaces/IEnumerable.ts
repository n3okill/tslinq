...
export interface IEnumerable<TSource> extends Iterable<TSource> {
  ...
  groupBy<TKey, TResult>(
    keySelector: Types.TKeySelector<TSource, TKey>,
    resultSelector?: Types.TResultSelector<TKey, TSource, TResult> | Interfaces.IEqualityComparer<TKey>,
    comparer?: Interfaces.IEqualityComparer<TSource>,
  ): IEnumerable<TResult>;
  /**
  ...
  groupByGrouped<TKey>(
    keySelector: Types.TKeySelector<TSource, TKey>,
  ): IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
  groupByGrouped<TKey, TElement>(
    keySelector: Types.TKeySelector<TSource, TKey>,
    elementSelector: Types.TElementSelector<TSource, TElement>,
  ): IEnumerable<Interfaces.IGrouping<TKey, TSource>>;
  groupByGrouped<TKey, TElement>(
  ...
  selectMany<TCollection, TResult>(
    selector?: Types.SelectManySelector<TSource, TCollection>,
    resultSelector?: Types.SelectManyResultSelector<TSource, TCollection, TResult>,
  ): IEnumerable<TResult>;
